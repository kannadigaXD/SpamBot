...
from KANNADIGAXD.utils import load_plugins
import logging
...
deadly = "🎉 Surprise Mother Fuckers Am Ready to fuck your moms 🎉 @karunadaking Enjoy! Do visit @karunada_kings_kingdom"
print(deadly[0: ])
